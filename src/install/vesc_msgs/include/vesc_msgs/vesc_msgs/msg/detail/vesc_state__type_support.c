...
static rosidl_typesupport_introspection_c__MessageMember vesc_msgs__msg__VescState__rosidl_typesupport_introspection_c__VescState_message_member_array[13] = {
  {
    "voltage_input",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vesc_msgs__msg__VescState, temperature_pcb),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
